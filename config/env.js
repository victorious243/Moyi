...
const env = {
  ...
  googleAdsClientId: process.env.GOOGLE_ADS_CLIENT_ID || process.env.GOOGLE_CLIENT_ID || '',
  googleAdsClientSecret: process.env.GOOGLE_ADS_CLIENT_SECRET || process.env.GOOGLE_CLIENT_SECRET || '',
  ...
  metaAdsAppId: process.env.META_ADS_APP_ID || process.env.META_APP_ID || '',
  metaAdsAppSecret: process.env.META_ADS_APP_SECRET || process.env.META_APP_SECRET || '',
