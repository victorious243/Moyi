module.exports = {
  ...
  'seo-growth-software': {
    ...
    seoTitle: 'SEO Growth Software & Audits | Moyi-CMO',
    seoDescription: 'Turn website scans, Search Console queries, and SEO issues into prioritized recommendations and multi-channel execution workflows.',
  ...
  'google-search-console-reporting-tool': {
    ...
    seoTitle: 'Google Search Console Reporting Tool | Moyi-CMO',
    seoDescription: 'Connect Google Search Console via read-only access to turn queries, CTR, impressions, and positions into actionable SEO recommendations.',
  ...
  'ai-content-marketing-platform': {
    ...
    seoTitle: 'AI Content Marketing Platform | Moyi-CMO',
    seoDescription: 'Create SEO content drafts, social posts, campaign plans, visuals, and publishing workflows from website evidence and approved business context.',
  ...
  'social-media-publishing-tool': {
    ...
    seoTitle: 'Social Media Publishing Tool | Moyi-CMO',
    seoDescription: 'Connect social accounts, approve drafts, publish or schedule posts, attach media, track status, and collect engagement metrics in one place.',
  ...
  'agency-seo-reporting-software': {
    ...
    seoTitle: 'Agency SEO Reporting Software | Moyi-CMO',
    seoDescription: 'Manage client projects, SEO evidence, recommendations, approved content, publishing, usage, and reporting in dedicated client workspaces.',
  ...
  'marketing-automation-for-startups': {
    ...
    seoTitle: 'Marketing Automation for Startups | Moyi-CMO',
    seoDescription: 'Prioritize SEO opportunities, create content, schedule approved social campaigns, and track progress without building a massive marketing team.',
