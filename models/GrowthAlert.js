...
const growthAlertSchema = new mongoose.Schema(
  {
    ...
    type: {
      ...
      enum: [
        ...
        'experiment_sample_too_small',
        'experiment_performance_risk',
        'funnel_leak_detected',
        'landing_page_underperforming',
        'website_conversion_drop',
        'cta_underperformance',
        'form_abandonment_spike',
        'market_opportunity',
        'channel_shift',
        'audience_shift',
    ...
    category: {
      type: String,
      enum: ['general', 'growth', 'revenue', 'content_approval', 'tracking', 'executive_briefing', 'goals', 'paid_performance', 'experimentation', 'strategic_intelligence'],
      default: 'growth',
      index: true
    },
    urgency: {
